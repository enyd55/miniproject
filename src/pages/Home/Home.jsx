    ...
    <div className="home-page">
      <header className="h-100 min-vh-100 d-flex align-items-center text-light">
        <div className="container d-flex flex-column align-items-center">
          ...
          <p>
            A Student-Based Personalized Website:It provides ease of access to
            the users, which consists of many quality of life features with some
        ...
        <div className="container">
          <div className="row d-flex align-items-center justify-content-around">
            <div className="col-lg-5">
              <h2 className="text-capitalize">Check out the Forums</h2>
              <p>
                View the Forums: Be sure to discuss with other users incase of
                queries, etc.
              </p>
              <Link to="/forum">
                <button
      ...
      <div className="py-5 bg-light">
        <div className="container">
          <div className="row d-flex align-items-center justify-content-around">
            <div className="col-lg-5">
              <h2 className="text-capitalize">Check out the planner</h2>
              <p>
                View the Planner. Look for new events and other interesting
                topics.
              </p>
              <Link to="/planner">
                <button
